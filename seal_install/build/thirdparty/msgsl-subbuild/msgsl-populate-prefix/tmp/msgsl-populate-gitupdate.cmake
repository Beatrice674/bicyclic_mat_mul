...
execute_process(
  COMMAND "/usr/bin/git" show-ref "a3534567187d2edc428efd3f13466ff75fe5805c"
  WORKING_DIRECTORY "/home/delld/xyy/seall/build/thirdparty/msgsl-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "a3534567187d2edc428efd3f13466ff75fe5805c")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("a3534567187d2edc428efd3f13466ff75fe5805c" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/a3534567187d2edc428efd3f13466ff75fe5805c")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/delld/xyy/seall/build/thirdparty/msgsl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/delld/xyy/seall/build/thirdparty/msgsl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

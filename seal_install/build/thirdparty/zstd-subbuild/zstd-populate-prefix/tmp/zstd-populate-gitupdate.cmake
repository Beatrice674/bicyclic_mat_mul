...
execute_process(
  COMMAND "/usr/bin/git" show-ref "f8745da6ff1ad1e7bab384bd1f9d742439278e99"
  WORKING_DIRECTORY "/home/delld/xyy/seall/build/thirdparty/zstd-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "f8745da6ff1ad1e7bab384bd1f9d742439278e99")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("f8745da6ff1ad1e7bab384bd1f9d742439278e99" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/f8745da6ff1ad1e7bab384bd1f9d742439278e99")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/delld/xyy/seall/build/thirdparty/zstd-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/delld/xyy/seall/build/thirdparty/zstd-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

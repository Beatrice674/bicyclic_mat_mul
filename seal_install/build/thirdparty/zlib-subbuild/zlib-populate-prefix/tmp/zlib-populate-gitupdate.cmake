...
execute_process(
  COMMAND "/usr/bin/git" show-ref "51b7f2abdade71cd9bb0e7a373ef2610ec6f9daf"
  WORKING_DIRECTORY "/home/delld/xyy/seall/build/thirdparty/zlib-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "51b7f2abdade71cd9bb0e7a373ef2610ec6f9daf")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("51b7f2abdade71cd9bb0e7a373ef2610ec6f9daf" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/51b7f2abdade71cd9bb0e7a373ef2610ec6f9daf")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/delld/xyy/seall/build/thirdparty/zlib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/delld/xyy/seall/build/thirdparty/zlib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

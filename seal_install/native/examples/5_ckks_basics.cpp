...
void example_ckks_basics()
{
    ...
    */
    ...
    // test for lazy reduction
    // print_line(__LINE__);
    // cout << "Lazy reduction test." << endl;
    // Ciphertext destination1, destination2, copy, copy1, copy2, copy3, copy4;
    // Plaintext plain1, plain2;
    // encryptor.encrypt(x_plain, copy);
    // copy1 = copy;
    // copy2 = copy;
    // copy3 = copy;   
    // copy4 = copy;
    // vector<Ciphertext> test_1{copy1, copy2}; 
    // vector<Ciphertext> test_2{copy3, copy4}; 
    // // evaluator.test_multiply_lazy(copy1, copy2, destination1, MemoryManager::GetPool());
    // evaluator.multiply_lazy(test_1, test_1, destination1, MemoryManager::GetPool());
    // evaluator.relinearize_inplace(destination1, relin_keys);
    // evaluator.rescale_to_next_inplace(destination1);
    // decryptor.decrypt(destination1, plain1);
    // vector<double> result1;
    // encoder.decode(plain1, result1);


    // evaluator.multiply_inplace(copy, copy);
    // evaluator.add(copy, copy, destination2);
    // evaluator.relinearize_inplace(destination2, relin_keys);
    // evaluator.rescale_to_next_inplace(destination2);
    // decryptor.decrypt(destination2, plain2);
    // vector<double> result2;
    // encoder.decode(plain2, result2);

    // if (result1[0] == result2[0] && result1[1] == result2[1])
    // {
    //     cout << "Lazy reduction test passed." << endl;
    // }
    // else
    // {
    //     cout << result1[0] << " " << result1[1] << endl;
    //     cout << result2[0] << " " << result2[1] << endl;
    //     cout << "Lazy reduction test failed." << endl;
    // }
